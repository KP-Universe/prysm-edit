...
import (
	...
	github_com_prysmaticlabs_prysm_v4_consensus_types_primitives "github.com/KP-Universe/prysm/v4/consensus-types/primitives"
	_ "github.com/KP-Universe/prysm/v4/proto/eth/ext"
...
type ListIndexedAttestationsRequest_Epoch struct {
	Epoch github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Epoch `protobuf:"varint,1,opt,name=epoch,proto3,oneof" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.Epoch"`
}
...
type ListBlocksRequest_Slot struct {
	Slot github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Slot `protobuf:"varint,2,opt,name=slot,proto3,oneof" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.Slot"`
}

type ListBlocksRequest_Epoch struct {
	Epoch github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Epoch `protobuf:"varint,3,opt,name=epoch,proto3,oneof" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.Epoch"`
}
...
type ChainHead struct {
	...
	HeadSlot                   github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Slot  `protobuf:"varint,1,opt,name=head_slot,json=headSlot,proto3" json:"head_slot,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.Slot"`
	HeadEpoch                  github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Epoch `protobuf:"varint,2,opt,name=head_epoch,json=headEpoch,proto3" json:"head_epoch,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.Epoch"`
	...
	FinalizedSlot              github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Slot  `protobuf:"varint,4,opt,name=finalized_slot,json=finalizedSlot,proto3" json:"finalized_slot,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.Slot"`
	FinalizedEpoch             github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Epoch `protobuf:"varint,5,opt,name=finalized_epoch,json=finalizedEpoch,proto3" json:"finalized_epoch,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.Epoch"`
	...
	JustifiedSlot              github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Slot  `protobuf:"varint,7,opt,name=justified_slot,json=justifiedSlot,proto3" json:"justified_slot,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.Slot"`
	JustifiedEpoch             github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Epoch `protobuf:"varint,8,opt,name=justified_epoch,json=justifiedEpoch,proto3" json:"justified_epoch,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.Epoch"`
	...
	PreviousJustifiedSlot      github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Slot  `protobuf:"varint,10,opt,name=previous_justified_slot,json=previousJustifiedSlot,proto3" json:"previous_justified_slot,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.Slot"`
	PreviousJustifiedEpoch     github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Epoch `protobuf:"varint,11,opt,name=previous_justified_epoch,json=previousJustifiedEpoch,proto3" json:"previous_justified_epoch,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.Epoch"`
...
type BeaconCommittees struct {
	...
	Epoch                github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Epoch `protobuf:"varint,1,opt,name=epoch,proto3" json:"epoch,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.Epoch"`
...
type ListValidatorBalancesRequest struct {
	...
	Indices     []github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.ValidatorIndex `protobuf:"varint,4,rep,packed,name=indices,proto3" json:"indices,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.ValidatorIndex"`
	PageSize    int32                                                                         `protobuf:"varint,5,opt,name=page_size,json=pageSize,proto3" json:"page_size,omitempty"`
	PageToken   string                                                                        `protobuf:"bytes,6,opt,name=page_token,json=pageToken,proto3" json:"page_token,omitempty"`
}
...
type ListValidatorsRequest struct {
	...
	Indices     []github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.ValidatorIndex `protobuf:"varint,7,rep,packed,name=indices,proto3" json:"indices,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.ValidatorIndex"`
}
...
type GetValidatorRequest_Index struct {
	Index github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.ValidatorIndex `protobuf:"varint,1,opt,name=index,proto3,oneof" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.ValidatorIndex"`
}
...
type ActiveSetChanges struct {
	...
	ActivatedIndices    []github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.ValidatorIndex `protobuf:"varint,3,rep,packed,name=activated_indices,json=activatedIndices,proto3" json:"activated_indices,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.ValidatorIndex"`
	...
	ExitedIndices       []github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.ValidatorIndex `protobuf:"varint,5,rep,packed,name=exited_indices,json=exitedIndices,proto3" json:"exited_indices,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.ValidatorIndex"`
	...
	SlashedIndices      []github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.ValidatorIndex `protobuf:"varint,7,rep,packed,name=slashed_indices,json=slashedIndices,proto3" json:"slashed_indices,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.ValidatorIndex"`
	...
	EjectedIndices      []github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.ValidatorIndex `protobuf:"varint,9,rep,packed,name=ejected_indices,json=ejectedIndices,proto3" json:"ejected_indices,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.ValidatorIndex"`
}
...
type ValidatorPerformanceRequest struct {
	...
	Indices    []github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.ValidatorIndex `protobuf:"varint,2,rep,packed,name=indices,proto3" json:"indices,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.ValidatorIndex"`
}
...
type ValidatorPerformanceResponse struct {
	...
	// Deprecated: Marked as deprecated in proto/prysm/v1alpha1/beacon_chain.proto.
	InclusionSlots []github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Slot `protobuf:"varint,2,rep,packed,name=inclusion_slots,json=inclusionSlots,proto3" json:"inclusion_slots,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.Slot"`
	// Deprecated: Marked as deprecated in proto/prysm/v1alpha1/beacon_chain.proto.
	InclusionDistances            []github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Slot `protobuf:"varint,3,rep,packed,name=inclusion_distances,json=inclusionDistances,proto3" json:"inclusion_distances,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.Slot"`
...
type SubmitSlashingResponse struct {
	...
	SlashedIndices []github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.ValidatorIndex `protobuf:"varint,1,rep,packed,name=slashed_indices,json=slashedIndices,proto3" json:"slashed_indices,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.ValidatorIndex"`
}
...
type IndividualVotesRequest struct {
	...
	Epoch      github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Epoch            `protobuf:"varint,1,opt,name=epoch,proto3" json:"epoch,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.Epoch"`
	PublicKeys [][]byte                                                                      `protobuf:"bytes,2,rep,name=public_keys,json=publicKeys,proto3" json:"public_keys,omitempty"`
	Indices    []github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.ValidatorIndex `protobuf:"varint,3,rep,packed,name=indices,proto3" json:"indices,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.ValidatorIndex"`
}
...
type BeaconCommittees_CommitteeItem struct {
	...
	ValidatorIndices []github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.ValidatorIndex `protobuf:"varint,1,rep,packed,name=validator_indices,json=validatorIndices,proto3" json:"validator_indices,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.ValidatorIndex"`
}
...
type ValidatorBalances_Balance struct {
	...
	Index     github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.ValidatorIndex `protobuf:"varint,2,opt,name=index,proto3" json:"index,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.ValidatorIndex"`
...
type Validators_ValidatorContainer struct {
	...
	Index     github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.ValidatorIndex `protobuf:"varint,1,opt,name=index,proto3" json:"index,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.ValidatorIndex"`
...
type ValidatorAssignments_CommitteeAssignment struct {
	...
	BeaconCommittees []github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.ValidatorIndex `protobuf:"varint,1,rep,packed,name=beacon_committees,json=beaconCommittees,proto3" json:"beacon_committees,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.ValidatorIndex"`
	CommitteeIndex   github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.CommitteeIndex   `protobuf:"varint,2,opt,name=committee_index,json=committeeIndex,proto3" json:"committee_index,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.CommitteeIndex"`
	AttesterSlot     github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Slot             `protobuf:"varint,3,opt,name=attester_slot,json=attesterSlot,proto3" json:"attester_slot,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.Slot"`
	ProposerSlots    []github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Slot           `protobuf:"varint,4,rep,packed,name=proposer_slots,json=proposerSlots,proto3" json:"proposer_slots,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.Slot"`
	// Deprecated: Marked as deprecated in proto/prysm/v1alpha1/beacon_chain.proto.
	PublicKey      []byte                                                                      `protobuf:"bytes,5,opt,name=public_key,json=publicKey,proto3" json:"public_key,omitempty" ssz-size:"48"`
	ValidatorIndex github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.ValidatorIndex `protobuf:"varint,6,opt,name=validator_index,json=validatorIndex,proto3" json:"validator_index,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.ValidatorIndex"`
}
...
type IndividualVotesRespond_IndividualVote struct {
	...
	ValidatorIndex                   github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.ValidatorIndex `protobuf:"varint,3,opt,name=validator_index,json=validatorIndex,proto3" json:"validator_index,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.ValidatorIndex"`
	...
	// Deprecated: Marked as deprecated in proto/prysm/v1alpha1/beacon_chain.proto.
	InclusionSlot github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Slot `protobuf:"varint,14,opt,name=inclusion_slot,json=inclusionSlot,proto3" json:"inclusion_slot,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.Slot"`
	// Deprecated: Marked as deprecated in proto/prysm/v1alpha1/beacon_chain.proto.
	InclusionDistance github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Slot `protobuf:"varint,15,opt,name=inclusion_distance,json=inclusionDistance,proto3" json:"inclusion_distance,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.Slot"`
