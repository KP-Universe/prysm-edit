...
type BeaconState struct {
	...
	Slot                        github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Slot `protobuf:"varint,1003,opt,name=slot,proto3" json:"slot,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.Slot"`
...
type PendingAttestation struct {
	...
	InclusionDelay  github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Slot           `protobuf:"varint,3,opt,name=inclusion_delay,json=inclusionDelay,proto3" json:"inclusion_delay,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.Slot"`
	ProposerIndex   github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.ValidatorIndex `protobuf:"varint,4,opt,name=proposer_index,json=proposerIndex,proto3" json:"proposer_index,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.ValidatorIndex"`
}
...
type Committee struct {
	...
	Index      github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.CommitteeIndex   `protobuf:"varint,1,opt,name=index,proto3" json:"index,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.CommitteeIndex"`
	...
	Validators []github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.ValidatorIndex `protobuf:"varint,3,rep,packed,name=validators,proto3" json:"validators,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.ValidatorIndex"`
}
