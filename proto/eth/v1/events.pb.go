...
import (
	...
	_ "github.com/KP-Universe/prysm/v4/proto/engine/v1"
...
type EventChainReorg struct {
	...
	Epoch               github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Epoch `protobuf:"varint,7,opt,name=epoch,proto3" json:"epoch,omitempty" cast-type:"github.com/KP-Universe/prysm/v4/consensus-types/primitives.Epoch"`
